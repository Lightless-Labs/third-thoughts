...
**Last updated:** 2026-05-26 (SWE-chat redaction provenance recorded)
...
- Tracked working-tree changes currently expected if this handoff is read mid-session: SWE-chat candidate registry/docs/todo updates in `docs/corpora/public-hf-analysis-corpora.json`, `docs/solutions/methodology/hf-corpus-analysis-ci-20260525.md`, `todos/swe-chat-hf-corpus-enable.md`, and this handoff. Commit once reviewed.
