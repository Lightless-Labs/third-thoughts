...
**Last updated:** 2026-05-26 (HF split smoke added for autonomous-stratum regression coverage)
...
- Tracked working-tree changes currently expected if this handoff is read mid-session: HF split-smoke workflow/docs updates in `.github/workflows/hf-corpus-analysis.yml`, `docs/solutions/methodology/hf-corpus-analysis-ci-20260525.md`, `todos/autonomous-session-stratum.md`, and this handoff. Commit once reviewed.
