...
**Last updated:** 2026-05-26 (SWE-chat per-user middens battery attempted)
...
- Tracked working-tree changes currently expected if this handoff is read mid-session: SWE-chat per-user middens runner/docs/handoff updates in `scripts/run_swe_chat_per_user_middens.py`, `docs/solutions/methodology/swe-chat-per-user-analysis-20260526.md`, `todos/swe-chat-hf-corpus-enable.md`, and this handoff. Commit and push once reviewed.
