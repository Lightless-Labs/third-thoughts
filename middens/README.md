...
> **Status: `0.0.1-beta.2`.** First public beta. Functional end-to-end on real corpora — but expect rough edges, incomplete privacy scrubbing in exports (see *Privacy notes* below), and a moving CLI surface. Available through Homebrew and GitHub Releases; not yet on crates.io.
...
```bash
curl -LO https://github.com/Lightless-Labs/third-thoughts/releases/download/v0.0.1-beta.2/middens-0.0.1-beta.2-aarch64-unknown-linux-gnu.tar.gz
tar xzf middens-0.0.1-beta.2-aarch64-unknown-linux-gnu.tar.gz
./middens-0.0.1-beta.2-aarch64-unknown-linux-gnu/middens --help
```

Apple Silicon macOS:

```bash
curl -LO https://github.com/Lightless-Labs/third-thoughts/releases/download/v0.0.1-beta.2/middens-0.0.1-beta.2-aarch64-apple-darwin.tar.gz
tar xzf middens-0.0.1-beta.2-aarch64-apple-darwin.tar.gz
./middens-0.0.1-beta.2-aarch64-apple-darwin/middens --help
```
